...
101102103N = number of solutions per problem626466687072747678% Problems Solved (Best-of-N)Process-Supervised RMOutcome-Supervised RMMajority Votingseries of
...
100101102Number of solutions labelled per problem2530354045505560% Problems Solved (Best-of-500)PRM + Active LearningPRM (PRMlarge supervised)ORM (PRMlarge supervised)ORM (final-answer supervised)100101102103N = number of solutions per problem202530354045505560% Problems Solved (Best-of-N)PRM (PRMlarge supervised)ORM (PRMlarge supervised)ORM (final-answer supervised)4.1 Process vs Outcome Supervision
...
it specifies both how
contrast, process supervision provides a richer signal:
...
Token count Present in pretraining?
...
1011030.00.20.40.60.81.0% Problems Solved (Best-of-N)Quintile 1 (easiest)PRMORM101103Quintile 2101103N = number of solutions per problemQuintile 3101103Quintile 4101103Quintile 5 (hardest)H Synthetic Supervision Details
...
In step 7, the generator makes an
Problem 6. Generator pass-rate: 93.5%.
incorrect attempt to simplify an expression. The reward model catches this
mistake.

Problem 7. Generator pass-rate: 48.0%.
